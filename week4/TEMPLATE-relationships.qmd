...
stream_chem_data <- read.csv(here::here("week4","data", "HubbardBrook_weekly_stream_chemistry_1963-2025.csv"))
...
#| warning: false
#.......................scatter + rug plot.......................
p1 + geom_rug() # single data point... data is highly clustered
```
...
p2 <- stream_chem_data |> 
  filter(waterYr == 2024) |> 
  ggplot(aes(x = DOC, y = pH, col = site)) + 
  geom_point(alpha = 0.5) + theme(legend.position = "bottom")

p2

#..................with marginal density plot....................
ggMarginal(p2, type = "density", groupFill = T, groupColour = T)
...
#......................add a smoothed line.......................
stream_chem_data %>% 
  filter(waterYr %in% c(2014:2024), site == "W5") %>% 
  ggplot(aes(x = DOC, y = pH)) + 
...
stream_chem_data |> 
  filter(waterYr == 2024) |> 
  ggplot(aes(x = DOC, y = pH, size = Al_ICP)) + 
  geom_point(alpha = 0.5) + 
...
stream_chem_data |> 
  ...
  geom_point(alpha = 0.5) +
  scale_size(range = c(1,10)) +  ## scale area of bubbles... use this instead!!
  labs(x = "DOC (mg/L)", size = "Al (mg/L)", color = "Site")
...
stream_chem_data |> 
  ...
  ggplot(aes(x = DOC, y = pH, color = site, size = Al_ICP)) + 
  geom_point(alpha = 0.5) +
  scale_radius(range = c(1, 10)) + ## never use... very deceiving
  labs(x = "DOC (mg/L)", size = "Al (mg/L)", color = "Site")
```
...
#..........................add rug plot..........................
ggplot(stream_chem_data, aes(x = SO4, y = pH)) + 
  geom_point(size = 0.5, alpha = 0.3) + geom_rug()
...
ggplot(stream_chem_data, aes(x = SO4, y = pH)) + 
  geom_bin2d() + scale_fill_viridis_c() # how to interpret?? Looking down on histogram... represents counts... brighter is more where clustered, and darker top-down histogram has sparser cluster

#..................heatmap with hexagonal bins...................
ggplot(stream_chem_data, aes(x = SO4, y = pH))  + geom_hex() + scale_fill_viridis_c()  + guides(fill = guide_colorbar(title = "Count",                                                                                                    barwidth = 1, barheight = 15))
# nicer to look at but same thing
```
...
#| warning: false
#..........................contour plot..........................
ggplot(stream_chem_data, aes(x = SO4, y = pH)) + geom_density_2d_filled()
# looking down on density plot... brighter spots are peaks in density curve (data points are highly clustered)
...
ggplot(stream_chem_data, aes(x = SO4, y = pH)) + 
  geom_hdr() # represents similar thing...BUT plots high density regions... within darkest grey area is 50% of all data points. Then, next is 80%, etc.
```
